...
public class fenetreAuthentificationTournamentSoftware {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					fenetreAuthentificationTournamentSoftware window = new fenetreAuthentificationTournamentSoftware();
	 ...
	 */
	public fenetreAuthentificationTournamentSoftware() {
		initialize();
	}
