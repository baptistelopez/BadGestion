...
//  private JButton bouton = new JButton("Appel à la corpsFenetreGestionCompetitions");
  ...
  public fenetreGestionCompetitionsCreationEtape1Generale(){
    ...
    comboBox_4.setBounds(170, 219, 296, 22);
    ...
    textField.setBounds(170, 301, 296, 22);
    ...
    btnSuivant.setBounds(369, 351, 97, 25);
    getContentPane().add(btnSuivant);
    
    JLabel lblPublics = new JLabel("Catégories de publics : ");
    lblPublics.setBounds(25, 254, 145, 34);
    getContentPane().add(lblPublics);
    
    JComboBox comboBox_5 = new JComboBox();
    comboBox_5.setBounds(0, 0, 31, 22);
